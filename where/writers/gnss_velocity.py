...
def gnss_velocity(dset: "Dataset") -> None:
    ...
    dset.add_float("site_vel_h", val=np.sqrt(vel_enu[:,0] ** 2 + vel_enu[:,1] ** 2) , unit="meter/second")
    ...
    dset.add_float("site_vel_sigma_x", val=np.sqrt(dset.estimate_cov_site_vel_xx), unit="meter/second")
    dset.add_float("site_vel_sigma_y", val=np.sqrt(dset.estimate_cov_site_vel_yy), unit="meter/second")
    dset.add_float("site_vel_sigma_z", val=np.sqrt(dset.estimate_cov_site_vel_zz), unit="meter/second")
