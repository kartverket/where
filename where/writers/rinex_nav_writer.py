...
FIELDS = (
    ...
    WriterField("gpsweek", "time", ("gps", "gps_ws", "week"), float, "%5.0f", 5, "WEEK", "", "GPS week"),
    WriterField(
...
""",
    ...
    WriterField("sv_accuracy", "sv_accuracy", (), float, "%8.0f", 8, "ACC", "", "Satellite vehicle accuracy"),
    WriterField("sv_health", "sv_health", (), float, "%8.0f", 8, "HLTH", "", "Satellite health status"),
    WriterField("dvs_e1", "dvs_e1", (), float, "%8.0f", 8, "DVS_E1", "", "Data validity status for E1 signal"),
    WriterField("dvs_e5a", "dvs_e5a", (), float, "%8.0f", 8, "DVS_E5a", "", "Data validity status for E5a signal"),
    WriterField("dvs_e5b", "dvs_e5b", (), float, "%8.0f", 8, "DVS_E5b", "", "Data validity status for E5b signal"),
    WriterField("shs_e1", "shs_e1", (), float, "%8.0f", 8, "SHS_E1", "", "Signal health status for E1 signal"),
    WriterField("shs_e5a", "shs_e5a", (), float, "%8.0f", 8, "SHS_E5a", "", "Signal health status for E5a signal"),
    WriterField("shs_e5b", "shs_e5b", (), float, "%8.0f", 8, "SHS_E5b", "", "Signal health status for E5b signal"),
)
