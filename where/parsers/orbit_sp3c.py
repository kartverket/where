"""A parser for reading SP3-c orbit files

Example:
--------

    from where import parsers
    p = parsers.parse_file(parser_name='orbit_sp3c', file_path='COD0MGXFIN_20180860000_01D_05M_ORB.SP3')
    data = p.as_dict()


Description:
------------
Reads data from SP3-c files (see :cite:`hilla2010` ). The reference frame is defined in the header of the SP3 file,
...
@plugins.register
class OrbitSp3cParser(ChainParser):
    """A parser for reading data from SP3-c orbit files
    ...
    def setup_parser(self):
        ...
        header_parser = ParserDef(
            ...
            parser_def={
                ...
                13: {"parser": self._parse_string, "fields": {"file_type": (3, 5), "time_sys": (9, 12)}},
                # ----+----1----+----2----+----3----+----4----+----5----+----6
                # %f  1.2500000  1.025000000  0.00000000000  0.000000000000000
                15: {"parser": self._parse_float, "fields": {"base_posvel": (3, 13), "base_clkrate": (14, 26)}},
            },
        )
    ...
    def _parse_position(self, line, cache):
        ...
        # Set bad or absent positional values to 'nan' indicated by 999999.999999
        ...
        elif float(line["clk_bias"]) == 999_999.999_999:
            line["clk_bias"] = float("nan")
