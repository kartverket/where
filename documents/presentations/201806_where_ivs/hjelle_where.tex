...
\newif\ifbibliography
\hypersetup{
            pdftitle={Making Where available to the community},
...
\begin{frame}{When?}
  ...
  \item Can do some SLR and GNSS analyses, in addition to VLBI
...
\begin{frame}{How?}
  ...
  \only<5->{
    We hope for a win-win:
    \begin{itemize}
    \item Where might be useful to you
    \item External use can give us useful feedback and validation
    \end{itemize}}
\end{frame}
